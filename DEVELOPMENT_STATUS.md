...
- [x] Implement the first title/introduction/bedroom/house/village/route story slice.
- [x] Implement reusable NPC records, face-and-A dialogue, objective flag, and finale trigger.
