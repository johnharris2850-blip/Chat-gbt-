...
def main() -> int:
    ...
    required = {
        ...
        "Makefile": ("PYTHON      := python3", "SOURCES     := src", "INCLUDES    := include", "DATA        :=", "GRAPHICS    := graphics", "AUDIO       := audio", "DMGAUDIO    :=", "LIBBUTANO   := $(BUTANO)", "include $(LIBBUTANOABS)/butano.mak", "TARGET      := crown_and_chaos"),
