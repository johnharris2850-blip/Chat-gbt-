...
def main() -> int:
    ...
    required = {
        ...
        "Makefile": ("tools/generate_placeholder_assets.py", 'LIBBUTANO="$(BUTANO)"', "make/Butano.mk"),
        "make/Butano.mk": ("LIBBUTANO   ?= $(BUTANO)", "include $(LIBBUTANO)/butano.mak", "TARGET      := crown_and_chaos"),
